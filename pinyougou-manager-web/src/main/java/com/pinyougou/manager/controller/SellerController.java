...
public class SellerController {
	 ...
	 */
	@RequestMapping("/add")
	public ReturnResult add(@RequestBody TbSeller seller){
		try {
	...
	public ReturnResult update(@RequestBody TbSeller seller){
		try {
	...
	public ReturnResult updateStatus(String sellerId,String status){
		try {
			sellerService.updateStatus(sellerId, status);
			return new ReturnResult(true, "成功");
		} catch (Exception e) {
			e.printStackTrace();
			return new ReturnResult(false, "失败");
		}
